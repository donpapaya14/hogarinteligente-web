...
def inject_amazon_links(content: str, amazon_keywords: list[str]) -> str:
    ...
    if amazon_keywords and "amazon.es" not in content:
        content += "\n\n---\n\n"
        content += "*Como afiliado de Amazon, gano por las compras adscritas que cumplan los requisitos. Si compras a través de estos enlaces nos ayudas a mantener el blog, sin coste extra para ti.*\n\n"
